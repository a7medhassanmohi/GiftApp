...
const flowers = [
  ...
  },
  {
    ...
    amount: 799.49,
    desc: "Alstroemerias",
    pic: "https://images-na.ssl-images-amazon.com/images/I/51mMNAQ5zpL.jpg",
  },
  {
    id: "e3",
    color: "yellow",
  ...
  },
  {
    ...
    amount: 549,
    desc: "Gardenias",
    pic: "https://sf.tac-cdn.net/images/products/large/FTD-TTB.jpg?auto=webp&quality=80",
  },
  {
    id: "e6",
    color: "yellow",
    amount: 623.49,
    desc: "Daisies",
    pic: "https://assets.eflorist.com/assets/products/PHR_/TRS15-1A.jpg",
  },
];
...
function Category() {
  ...
  const filtredFlowers = flowers.filter((expense) => {
    if (desc === "all" && color === "all") {
    ...
    <div>
      <div className="jumbotron jumbotron-fluid bg-dark">
        <div className="container">
          ...
          <div className="acd  text-center">∿∿∿∿∿</div>{" "}
        </div>
      </div>
          ...
          <div className="col-md-3">
            <div className="row">
              <div className=" col-4 col-md-12">
                <DescFilter descvalue={changedesc} />
              </div>
              <div className=" d-flex align-items-center justify-content-center  col-4 col-md-12">
                <PriceFilter
                  value={value}
                  ind={value}
                  changePrice={changePrix}
                />
              </div>
              <div className=" col-4 col-md-12">
                <ColorFilter colorvalue={changeColor} />
              </div>
            </div>
          </div>
          <div className="col-md-9">
            ...
            <p className="text-center w-75">40$</p>
              ...
              {filtredFlowers.map((el) => {
                return (
                  <div
                    className="col-md-4  d-flex align-items-center justify-content-center flex-column mt-3"
                    key={el.id}
                  >
                    <div className="position-relative show-icons bg-dark">
                      ...
                      <div className=" w-100 social d-flex align-items-center justify-content-center">
                        <div className="social-i d-flex align-items-center justify-content-center">
                          {" "}
                          <i className="fas fa-shopping-cart"></i>
                        </div>
                        <div className="social-i d-flex align-items-center justify-content-center text-danger">
                    ...
                    <p
                      className="text-center w-75 mt-3 flowerFont"
                      style={{ fontSize: "22px" }}
                    >
                      {el.desc}
                    </p>
